...
namespace ShopEase.Common.EmailNotification
{
    /// <summary>
    ...
    public class EmailNotification
    {
        ...
        //        {
        //            var pdf = new PdfDocument(pdfWriter); var document = new Document(pdf);
        //            var img = new PdfImage(ImageDataFactory.Create(imageBytes)).SetAutoScale(true).SetHorizontalAlignment(PdfProperties.HorizontalAlignment.CENTER);
        //            document.Add(img); document.Close(); pdf.Close(); System.IO.File.WriteAllBytes(savepdfGeneratePath, ms.ToArray()); return 1;
        //            //return ms.ToArray();
        //        }
        //    }
        //}
